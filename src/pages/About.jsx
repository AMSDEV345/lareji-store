...
const TEAM = [
  { name: "Lanrewaju", role: "Founder & CEO",  },
  { name: "Favour", role: "Head of Sourcing",  },
];
      ...
      <section className="about-hero" ref={heroRef}>
        ...
        <div className="about-hero__content">
          ...
          <p ref={paraRef} className="about-hero__para">
            Born from a deep love of African food culture, LAREJI was built to
            bridge the gap between authentic African ingredients and modern
            kitchens — locally and globally.
          </p>
          <div ref={btnRef}>
        ...
        <Container>
          ...
          <div className="about-story__grid">
            <div className="about-story__text anim-fade-left">
              ...
              <p>
                Today, LAREJI ships premium African ingredients to customers
                across Nigeria and internationally — each product carefully
                selected, hygienically packaged, and delivered with the story
                of its origin intact.
              </p>
              <p>
                <strong>This isn't just food. It's culture, memory, and
                home</strong> — delivered to your door wherever you are in
                the world.
              </p>
            </div>
          </div>
        ...
        <Container>
          <div className="about-mission__inner" ref={missionRef}>
            ...
            <p className="about-mission__quote">
              "To make authentic African ingredients{" "}
              <em>accessible, trustworthy, and beautifully presented</em> —
              for every kitchen, everywhere."
            </p>
