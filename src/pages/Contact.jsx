  ...
  return (
    <>
      <style>{`
        /* ── Hero ── */
        .contact-hero {
          margin-top: 72px; background: var(--charcoal);
          padding: clamp(72px,12vw,140px) clamp(28px,6vw,80px);
          position: relative; overflow: hidden;
          display: flex; align-items: center; min-height: 52vh;
        }
        ...
        .contact-hero__title em { font-style: italic; color: rgba(255,255,255,0.45); }
        ...
        .field textarea,
        .field select {
          padding: 13px 16px; background: linear-gradient(rgba(51, 48, 42, 0), rgba(85, 84, 82, 0.34)), url('/bg-beige.jpg');
background-size: cover;
background-attachment: fixed;-deep);
          border: 1px solid var(--beige-dark); font-family: var(--sans);
        ...
        .contact-form__success {
          background: rgba(30,75,50,0.08); border: 1px solid var(--green);
          padding: 20px 24px; display: flex; align-items: center; gap: 14px;
          animation: fadeUp 0.5s var(--ease-out) both;
        }
        .contact-form__success-icon { font-size: 28px; }
        .contact-form__success-text { font-size: 14px; color: var(--green); line-height: 1.6; }
        ...
        .contact-form__divider::after {
          content: ''; flex: 1; height: 1px; background: linear-gradient(rgba(83, 83, 82, 0.95), rgba(245, 242, 235, 0.29)), url('/bg-beige.jpg');
background-size: cover;
background-attachment: fixed;-dark);
        ...
        .contact-info__item {
          ...
          padding: 24px; background: linear-gradient(rgba(75, 52, 0, 0.18), rgba(245, 242, 235, 0.2)), url('/bg-beige.jpg');
background-size: cover;
background-attachment: fixed;-deep);
        ...
        .contact-info__item:hover .contact-info__icon { transform: scale(1.2) rotate(-5deg); }
        .contact-info__label {
          font-size: 9px; letter-spacing: 2.5px; text-transform: uppercase;
        ...
        .contact-info__sub { font-size: 12px; color: var(--muted); font-weight: 300; }

        /* ── Socials ── */
        .contact-socials { padding: 72px 0; background: linear-gradient(rgba(245, 242, 235, 0.1), rgba(245, 242, 235, 0.14)), url('/bg-beige.jpg');
background-size: cover;
background-attachment: fixed;-deep); }
        ...
        .social-card {
          background: linear-gradient(#cfa6b45b, rgba(194, 155, 66, 0.95)), url('/bg-beige.jpg');
background-size: cover;
background-attachment: fixed;); padding: 40px 32px;
          text-align: center;
          transition: transform 0.3s ease, box-shadow 0.3s ease;
        ...
        .social-card__handle {
          ...
          color: var(--charcoal); margin-bottom: 16px; display: block;
        }
        .social-card__arrow {
        ...
        /* ── Map placeholder ── */
        .contact-map {
          background: linear-gradient(rgba(71, 71, 69, 0.95), rgba(245, 242, 235, 0.37)), url('/bg-beige.jpg');
background-size: cover;
background-attachment: fixed;-deep); height: 320px;
          display: flex; align-items: center; justify-content: center;
          flex-direction: column; gap: 14px; border-top: 1px solid var(--beige-dark);
        }
        .contact-map__emoji { font-size: 52px; animation: floatUp 4s ease-in-out infinite; }
        .contact-map__text  { font-family: var(--serif); font-size: 22px; color: var(--muted); }
        .contact-map__sub   { font-size: 12px; color: var(--muted); opacity: 0.6; }
      `}</style>
                ...
                <form className="contact-form" onSubmit={handleSubmit}>
                  <div className="contact-form__row">
                    <div className="field">
                      ...
                      <input
                        name="name" required placeholder="e.g. Amaka Obi"
                  ...
                  <div className="field">
                    <label>Subject</label>
                    <input
                      name="subject" required placeholder="e.g. Order enquiry, Wholesale"
                  ...
                  <div className="field">
                    <label>Message</label>
                    <textarea
                      name="message" required placeholder="Tell us what you need..."
      ...
      <div className="contact-map">
        ...
        <p className="contact-map__sub">Replace with Google Maps embed</p>
      </div>
    </>
  );
}