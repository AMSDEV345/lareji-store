    ...
    <>
      <style>{`
        ...
        .nav__link {
          ...
          padding-bottom: 3px; transition: color 0.2s; background: none; border: none;
        ...
        .nav__badge {
          ...
          border-radius: 50%; width: 18px; height: 18px; font-size: 10px; font-weight: 500;
...
background-attachment: fixed;); z-index: 199;
        ...
        .nav__mobile-link {
          ...
          color: var(--charcoal); cursor: pointer; transition: color 0.2s;
          background: none; border: none;
        }
        .nav__mobile-link:hover { color: var(--green); }
        .nav__mobile-cart {
          background: var(--green); color: var(--white); border: none;
          padding: 14px 44px; font-size: 11px; letter-spacing: 2.5px;
          text-transform: uppercase; font-family: var(--sans); cursor: pointer; margin-top: 8px;
        }
